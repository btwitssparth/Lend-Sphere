...
import { getLenderRequests, getMyRentals } from '../api/rentals'; // 🔥 Added API imports
import { Moon, Sun, Menu, X, LogOut, LayoutDashboard, Package, PlusCircle, Bell, Circle } from 'lucide-react'; // 🔥 Added Bell icon
...
const Navbar = () => {
            ...
            try {
                ...
                if (approvedRentals.length > 0) {
                    newNotifs.push({
                        ...
                        link: '/my-rentals',
                        icon: <CheckCircle className="w-4 h-4 text-green-500" /> // Use standard Check if CheckCircle not imported, but package is fine
                    });
                }
    ...
    // Close one dropdown when opening the other
